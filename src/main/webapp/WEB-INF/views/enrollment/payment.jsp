...
<head>
    <meta charset="UTF-8">
    <title>Payment &ndash; DriveEdu</title>
...
<div class="wrapper">
    ...
    <div class="main-content">
        <div class="topbar">
            <span class="topbar-title">Secure Checkout</span>
        ...
        <div class="page-body">
            <div class="page-header">
                <div class="breadcrumb">
                    ...
                    <a href="${pageContext.request.contextPath}/student/enroll">Browse</a> &rsaquo;
                    <a href="${pageContext.request.contextPath}/student/enroll/details?courseId=${course.courseId}">${course.courseName}</a> &rsaquo;
                    Payment
                </div>
            ...
            <div class="pay-grid">
                ...
                <div class="pay-card">
                    ...
                    <form action="${pageContext.request.contextPath}/student/enroll" method="post" id="payForm">
                        ...
                        <button type="submit" class="btn btn-gold" style="width:100%;margin-top:1rem;font-size:1.05rem;padding:.75rem;font-weight:600;">
                            Pay LKR <fmt:formatNumber value="${course.price}" type="number" minFractionDigits="2" maxFractionDigits="2"/>
                        </button>

                        <div class="secure-note">
                            Your payment is processed securely via encrypted tunnel.
                        </div>
                    </form>
                </div>
                ...
                <div>
                    <div class="pay-card">
                        ...
                        <div class="summary-row">
                            ...
                            <span style="font-weight:600;text-align:right;color:var(--text-main);">${course.courseName}</span>
                        </div>
                        <div class="summary-row">
                            <span style="color:var(--text-muted);">License Category</span>
                            <span style="font-weight:600;color:var(--text-main);">${course.licenseCategory}</span>
                        </div>
                        <div class="summary-row">
                            <span style="color:var(--text-muted);">Training Hours</span>
                            <span style="font-weight:600;color:var(--text-main);">${course.totalHours} hrs</span>
                        </div>
                        <div class="summary-row">
...
<script>
    // Light formatting niceties — purely cosmetic, not validation
